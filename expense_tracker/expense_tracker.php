...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">                            
                            <form id="myForm1" name="myForm1" action="#" method="POST"> 
                                <div class="mb-2">
                                    <label for="parent_c_id" class="form-label text-danger">Parent Category Name*</label>
                                    <select class="form-select" id="parent_c_id" name="parent_c_id" required>
                                        <option value=''>Select</option>
                                    </select>
                                </div> 
                                <div class="mb-2">
                                    <label for="sub_c_id" class="form-label text-danger">Sub Category Name*</label>
                                    <select class="form-select" id="sub_c_id" name="sub_c_id" required>
                                        <option value=''>Select</option>
                                    </select>
                                </div> 
                                <div class="mb-2">
                                    <label for="narration" class="form-label text-danger">Narration*</label>
                                    <textarea class="form-control" id="narration" name="narration" required></textarea>
                                </div> 
                                <div class="mb-2">
                                    <label for="exp_amount" class="form-label text-danger">Amount*</label>
                                    <input type="text" class="form-control" id="exp_amount" name="exp_amount" required>
                                </div>  
                                <div class="mb-2">
                                    <label for="exp_date" class="form-label text-danger">Date*</label>
    ...
    <script src="expense_tracker/function.js?d=<?=date('Ymdhis')?>"></script>
