...
<body> 
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="buttons-table-preview">
                                            <div class="table-responsive"> 
                                                ...
                                                <table id="balance_sheet" class="table table-sm table-bordered mb-0">
                                                    <thead>
                                                        <tr>
                                                            <td colspan="2" style="text-align:center;">Liabilities</td>
    ...
    <script src="balance_sheet/function.js?d=<?=date('Ymdhis')?>"></script>
