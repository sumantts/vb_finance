...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">                            
                            <form id="myForm" name="myForm" action="#" method="POST">
                                <div class="mb-3">
                                    <label for="FullNm" class="form-label text-danger">User Full Name*</label>
                                    <input type="text" class="form-control" id="FullNm" name="FullNm" aria-describedby="FullNm" required>
                                </div>
                                <div class="mb-3">
                                    <label for="UsrNm" class="form-label text-danger">User Name*</label>
                                    <input type="text" class="form-control" id="UsrNm" name="UsrNm" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="GrpId" class="form-label text-danger">Under User Group*</label>
                                    <select class="form-control" id="GrpId" name="GrpId" required>
    ...
    <script src="configuration/user_details/function.js?d=<?=date('Ymdhis')?>"></script>
